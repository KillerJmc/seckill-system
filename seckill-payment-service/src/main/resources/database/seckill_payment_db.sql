...
CREATE TABLE `sk_seckill_success` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `seckill_success_account_id_uindex` (`account_id`),
  UNIQUE KEY `seckill_success_seckill_id_uindex` (`seckill_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='秒杀成功客户表';
...
INSERT INTO `sk_storage` VALUES (1,1298850693,10000,'2022-03-04 13:26:23','2022-03-04 13:26:23');
...
-- Dump completed on 2022-03-04 20:07:41
